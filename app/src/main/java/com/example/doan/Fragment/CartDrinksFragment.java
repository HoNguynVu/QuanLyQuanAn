...
import com.example.doan.databinding.CartDrinksFragmentBinding;

import java.util.ArrayList;
import java.util.List;

public class CartDrinksFragment extends Fragment {
    List<String> titles;
    List<String> prices;
    List<Integer> images;
    HomePopularItemAdapter adapter;
    private CartDrinksFragmentBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = CartDrinksFragmentBinding.inflate(inflater, container, false);
