...
import com.example.doan.databinding.UserShoppingAppetizerFragmentBinding;

import java.util.ArrayList;
import java.util.List;


public class UserShoppingAppetizerFragment extends Fragment {
    UserMenuAdapter adapter;
    private UserShoppingAppetizerFragmentBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = UserShoppingAppetizerFragmentBinding.inflate(inflater, container, false);
